...
def main():
    for f_dir in f_dirs:
        ...
        for rep in tqdm(range(total_rep)):
            ...
            savemat(save_fn_sepStim, {"data": reshaped_data_sepStim})
...
def reshape_data(n):
    ...
    # cond1_idx = np.logical_and(
    #     n.choice == 0, np.logical_and(stim_dir == 135, targ_arrange == 0)
    # )
    # cond2_idx = np.logical_and(
    #     n.choice == 0, np.logical_and(stim_dir == 135, targ_arrange == 1)
    # )
    # cond3_idx = np.logical_and(
    #     n.choice == 0, np.logical_and(stim_dir == 315, targ_arrange == 0)
    # )
    # cond4_idx = np.logical_and(
    #     n.choice == 0, np.logical_and(stim_dir == 315, targ_arrange == 1)
    # )

    # cond5_idx = np.logical_and(
    #     n.choice == 1, np.logical_and(stim_dir == 135, targ_arrange == 0)
    # )
    # cond6_idx = np.logical_and(
    #     n.choice == 1, np.logical_and(stim_dir == 135, targ_arrange == 1)
    # )
    # cond7_idx = np.logical_and(
    #     n.choice == 1, np.logical_and(stim_dir == 315, targ_arrange == 0)
    # )
    # cond8_idx = np.logical_and(
    #     n.choice == 1, np.logical_and(stim_dir == 315, targ_arrange == 1)
    # )
